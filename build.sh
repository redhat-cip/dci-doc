...
do
    mkdir -p ./src/${project}
    curl -L https://api.github.com/repos/redhat-cip/dci-openstack-agent/tarball| tar xfz - --wildcards --no-anchored 'README*.md' --strip-components=1 --one-top-level=./src/${project}
done
