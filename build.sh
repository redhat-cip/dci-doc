...
mkdir ${temp_folder}
cp -r . ${temp_folder}
projects="dci-control-server dci-ui python-dciclient python-dciauth dci-downloader dci-openstack-agent dci-rhel-agent ansible-playbook-dci-beaker dci-openshift-agent"
