...
.. http:post:: /api/v1/users
   ...
   **Example response**:
   ...
   :jsonparam name: Name of the user
   :jsonparam password: Password for the new user
   :jsonparam role: Role of the user, this is an enum, possible values
    are: ``admin``, ``user``
   :jsonparam team_id: ID of the team whom the user belongs
...
.. http:put:: /api/v1/users/<user-id>
   ...
   **Example request**:
   ...
   .. sourcecode:: http
      ...
      PUT /api/v1/users/cbd0ad1b-1f4b-4056-8c82-27ff9511e37f HTTP/1.1
      Accept: application/json
      Authorization: Basic YWRtaW46YWRtaW4=
      Content-Length: 16
      Content-Type: application/json
   ...
   **Example response**:
   ...
   :jsonparam name: Updated name of the user
   :jsonparam password: Updated password of the user
   :jsonparam role: Updated role of the user, this is an enum,
...
.. http:delete:: /api/v1/users/<user-id>

   Delete a user. This action can only be done by the administrator of the
   ...
   **Example request**:
   ...
   .. sourcecode:: http
      ...
      DELETE /api/v1/users/cbd0ad1b-1f4b-4056-8c82-27ff9511e37f HTTP/1.1
      Accept: application/json
...
.. http:get:: /api/v1/users/<user-id>
   ...
   **Example request**:
   ...
   .. sourcecode:: http
      ...
      GET /api/v1/users/660abf0b998bf17842f376ca6def6eae HTTP/1.1
      Accept: application/json
      Authorization: Basic YWRta321YWetaW4=
      Content-Length: 0
      Host: 127.0.0.1:5000
...
.. http:get:: /api/v1/users
   ...
   Get all users. This request will be scoped to your team, it is
   not possible to visualize users of another team.
